...
// }
// $name = "Roma";
// $user_email = "romaniv.roma228@gmail.com";
// $message = "test";
    ...
    <div class="dropdown show">
      ...
      <section class="contact container">
        ...
        <div class="bubble b2"></div>
          ...
          <div class="row">
              <input name="name" class="name col-md-5" type="text" placeholder="Ваше Имя" value="<?php echo $name; ?>">
              <div class="col-md-1"></div >
              <input name="email" class="email col-md-6" type="email" placeholder="Ваш Email" value="<?php echo $mail; ?>">
          </div>
          <div class="row ">
              <!-- <input class="message col-md-12" type="text" placeholder="Ваше Сообщение"> -->
              <textarea name="message" class="form-control message" id="exampleFormControlTextarea1" rows="6" placeholder="Ваше сообщение" value="<?php echo $message; ?>"></textarea>

          </div>
          <div class="row">
              <!-- <button class="button">Отправить</button> -->
              <button name="submit" type="submit" class="button" style="vertical-align:middle"><span>Отправить </span></button>
            </div>
            </form>
      </section>
